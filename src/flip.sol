...
/*
   This thing lets you flip some gems for a given amount of solg.
   Once the given amount of solg is raised, gems are forgone instead.

 - `lot` gems in return for bid
 - `tab` total solg wanted
 - `bid` solg paid
 - `gal` receives solg income
...
contract Flipper {
    ...
    struct Bid {
        ...
        address usr;
        address gal;
        uint256 tab;  // total solg wanted         [rad]
    }
