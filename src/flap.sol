...
// Copyright (C) 2022 Solg Foundation
//
...
/*
   This thing lets you sell some solg in return for gems.

 - `lot` solg in return for bid
 - `bid` gems paid
...
contract Flapper {
    ...
    struct Bid {
        ...
        uint256 lot;  // solg in return for bid   [rad]
    ...
    uint256  public lid;   // max solg to be in auction at one time  [rad]
    uint256  public fill;  // current solg in auction                [rad]
