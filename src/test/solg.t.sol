...
contract TokenUser {
    ...
    constructor(Solg token_) public {
        token = token_;
    }
...
contract SolgTest is DSTest {
    ...
    function createToken() internal returns (Solg) {
        return new Solg(99);
    }
    ...
    function testSolgAddress() public {
        //The solg address generated by hevm
